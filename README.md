...
| [`TeoryEng.md`](TeoryEng.md) | **Archivo de trabajo principal (Markdown)** — Prólogo, Capítulos 1–8 completos en inglés; capítulos siguientes se irán agregando uno por uno |
...
- **Capítulo 9 y siguientes / Chapter 9 onwards:** pendiente de traducción *(próximamente)*
