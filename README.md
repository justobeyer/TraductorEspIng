...
| [`TeoryEng.md`](TeoryEng.md) | **Archivo de trabajo principal (Markdown)** — Prólogo, Capítulos 1, 2, 3 y 4 completos en inglés; capítulos siguientes se irán agregando uno por uno |
...
- **Capítulo 5 y siguientes / Chapter 5 onwards:** pendiente de traducción *(próximamente)*
